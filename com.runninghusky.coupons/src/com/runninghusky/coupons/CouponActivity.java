...
public class CouponActivity extends Activity implements Runnable{
	ListView list;
	...
	public void getCategories() {
		pd = ProgressDialog.show(this, "", "Fetching coupons...", true, false);
...
//			Log.d("mylist.size: ", String.valueOf(mylist.size()));
			...
			list.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> a, View v, int position,
					...
					Intent myIntent = new Intent(CouponActivity.this, OpenCoupon.class);
					Bundle b = new Bundle();
					b.putString("url", img);
					myIntent.putExtras(b);
					CouponActivity.this.startActivity(myIntent);
				}
			});
		} else {
